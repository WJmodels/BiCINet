...
class QEDDataset(Dataset):
    def __init__(self, **kwargs):
        ...
        self.scale = kwargs.pop('scale') if 'scale' in kwargs.keys() else 100
        self.min_value = kwargs.pop('min_value') if 'min_value' in kwargs.keys() else 0
        self.max_value = kwargs.pop('max_value') if 'max_value' in kwargs.keys() else 1
        self.augment_prob = kwargs.pop('augment_prob') if 'augment_prob' in kwargs.keys() else 0
        # augment_range unit ±ppm
        self.augment_range = kwargs.pop('augment_range') if 'augment_range' in kwargs.keys() else 0.05
        self.units = (self.max_value - self.min_value) * self.scale
        self.start = kwargs.pop('start') if 'start' in kwargs.keys() else 191
        self.end = kwargs.pop('end') if 'end' in kwargs.keys() else 192
        self.number_start = kwargs.pop('number_start') if 'number_start' in kwargs.keys() else 200
    ...
    def augment_item(self, QED, want_token=True):
        QED = list(set(QED))
        offset = np.random.normal(loc=0.0, scale=self.augment_range/2, size=len(QED))
        offset = [min(max(-self.augment_range, i), self.augment_range) for i in offset]
        offset = [self.get_value(i, self.augment_prob) for i in offset]
        new_QED = [QED_item + offset_item for QED_item,offset_item in zip(QED, offset)]
...
class molecular_weightDataset(Dataset):
    def __init__(self, **kwargs):
        ...
        self.scale = kwargs.pop('scale') if 'scale' in kwargs.keys() else 1
        self.min_value = kwargs.pop('min_value') if 'min_value' in kwargs.keys() else 0
        self.max_value = kwargs.pop('max_value') if 'max_value' in kwargs.keys() else 1000
        self.augment_prob = kwargs.pop('augment_prob') if 'augment_prob' in kwargs.keys() else 0
        # augment_range unit ±ppm
        self.augment_range = kwargs.pop('augment_range') if 'augment_range' in kwargs.keys() else 50
        self.units = (self.max_value - self.min_value) * self.scale
        self.start = kwargs.pop('start') if 'start' in kwargs.keys() else 185
        self.end = kwargs.pop('end') if 'end' in kwargs.keys() else 186
        self.number_start = kwargs.pop('number_start') if 'number_start' in kwargs.keys() else 300
    ...
    def augment_item(self, molecular_weight, want_token=True):
        molecular_weight = list(set(molecular_weight))
        offset = np.random.normal(loc=0.0, scale=self.augment_range/2, size=len(molecular_weight))
        offset = [min(max(-self.augment_range, i), self.augment_range) for i in offset]
        offset = [self.get_value(i, self.augment_prob) for i in offset]
        new_molecular_weight = [molecular_weight_item + offset_item for molecular_weight_item, offset_item in zip(molecular_weight, offset)]
...
class logPDataset(Dataset):
    def __init__(self, **kwargs):
        ...
        self.scale = kwargs.pop('scale') if 'scale' in kwargs.keys() else 10
        self.min_value = kwargs.pop('min_value') if 'min_value' in kwargs.keys() else -4
        self.max_value = kwargs.pop('max_value') if 'max_value' in kwargs.keys() else 7
        self.augment_prob = kwargs.pop('augment_prob') if 'augment_prob' in kwargs.keys() else 0
        # augment_range unit ±ppm
        self.augment_range = kwargs.pop('augment_range') if 'augment_range' in kwargs.keys() else 0.5
        self.units = (self.max_value - self.min_value) * self.scale
        self.start = kwargs.pop('start') if 'start' in kwargs.keys() else 193
        self.end = kwargs.pop('end') if 'end' in kwargs.keys() else 194
        self.number_start = kwargs.pop('number_start') if 'number_start' in kwargs.keys() else 1300
    ...
    def augment_item(self, logP, want_token=True):
        logP = list(set(logP))
        offset = np.random.normal(loc=0.0, scale=self.augment_range/2, size=len(logP))
        offset = [min(max(-self.augment_range, i), self.augment_range) for i in offset]
        offset = [self.get_value(i, self.augment_prob) for i in offset]
        new_logP = [logP_item + offset_item for logP_item, offset_item in zip(logP, offset)]
...
class SADataset(Dataset):
    def __init__(self, **kwargs):
        ...
        self.scale = kwargs.pop('scale') if 'scale' in kwargs.keys() else 10
        self.min_value = kwargs.pop('min_value') if 'min_value' in kwargs.keys() else 1
        self.max_value = kwargs.pop('max_value') if 'max_value' in kwargs.keys() else 10
        self.augment_prob = kwargs.pop('augment_prob') if 'augment_prob' in kwargs.keys() else 0
        # augment_range unit ±ppm
        self.augment_range = kwargs.pop('augment_range') if 'augment_range' in kwargs.keys() else 0.5
        self.units = (self.max_value - self.min_value) * self.scale
        self.start = kwargs.pop('start') if 'start' in kwargs.keys() else 195
        self.end = kwargs.pop('end') if 'end' in kwargs.keys() else 196
        self.number_start = kwargs.pop('number_start') if 'number_start' in kwargs.keys() else 1410
    ...
    def augment_item(self, SA, want_token=True):
        ...
        offset = [min(max(-self.augment_range, i), self.augment_range) for i in offset]
        offset = [self.get_value(i, self.augment_prob) for i in offset]
        new_SA = [SA_item + offset_item for SA_item, offset_item in zip(SA, offset)]
...
class NmrDataset(Dataset):
    def __init__(self, **kwargs):
        ...
        self.scale = kwargs.pop('scale') if 'scale' in kwargs.keys() else 10
        self.min_value = kwargs.pop('min_value') if 'min_value' in kwargs.keys() else -50
        self.max_value = kwargs.pop('max_value') if 'max_value' in kwargs.keys() else 350
        self.augment_prob = kwargs.pop('augment_prob') if 'augment_prob' in kwargs.keys() else 0.5
        # augment_range unit ±ppm
        self.augment_range = kwargs.pop('augment_range') if 'augment_range' in kwargs.keys() else 1.5
        self.units = (self.max_value - self.min_value) * self.scale
        self.start = kwargs.pop('start') if 'start' in kwargs.keys() else 189
        self.end = kwargs.pop('end') if 'end' in kwargs.keys() else 190
        self.number_start = kwargs.pop('number_start') if 'number_start' in kwargs.keys() else 191
    ...
    def augment_item(self, nmr, want_token=True):
        nmr = list(set(nmr))
        offset = np.random.normal(loc=0.0, scale=self.augment_range/2, size=len(nmr))
        offset = [min(max(-self.augment_range, i), self.augment_range)for i in offset]
        offset = [self.get_value(i, self.augment_prob) for i in offset]
        new_nmr = [nmr_item + offset_item for nmr_item, offset_item in zip(nmr, offset)]
